...
public class CodebookCurationComboBox
    extends StyledComboBox<CodebookTag>
{
    ...
    private CodebookCurationNodePanel parentPanel;
    private @SpringBean CodebookSchemaService codebookService;

    public CodebookCurationComboBox(CodebookCurationNodePanel parentPanel, String id,
            IModel<String> model, List<CodebookTag> choices)
    {
        ...
        this.add(new AjaxFormComponentUpdatingBehavior("blur")
        {
            ...
            protected void onUpdate(AjaxRequestTarget target)
            {
                ...
                String user = WebAnnoConst.CURATION_USER;
                newUserTag.setDescription("This tag was created by " + user + "!");

                // parent tag
                // TODO
                // parentPanel.getParentNodePanel(node);
                CodebookCurationNodePanel parentNodePanel = null;
