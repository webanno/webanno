...
public abstract class ColoringStrategy
{
	...
	public static final ColoringStrategy labelHashBasedColor(final String... aPalette)
	{
		return new ColoringStrategy()
		{
			...
			public String getColor(VID aVid, String aLabel)
			{
				...
				if (colorIndex == Integer.MIN_VALUE) { // FIXME: does that make sense? Integer.MIN_VALUE is  -2147483648, Math.abs produces only positive numbers, doesn't it?
					colorIndex = 0;
				}
	...
	/**
	 * same as <code>labelHashBasedColor</code> with a palette of size 1
	 */
	@Deprecated
	public static ColoringStrategy staticColor(final String aColor) {
		return labelHashBasedColor(aColor);
	}
			...
			Map<String[], Queue<String>> aColorQueues)
	{
		...
		case STATIC:
			...
			return staticColor(nextPaletteEntry(PALETTE_PASTEL, aColorQueues, threshold));
		...
		case GRAY: 
		default: return staticColor(DISABLED);
		}
	}
	
	
	public static ColoringStrategyType getBestInitialStrategy(
			AnnotationSchemaService aService, 
			AnnotationLayer aLayer,
			AnnotationPreference aPreferences)
	{
...
//	public static ColoringStrategy getBestStrategy(
//			AnnotationSchemaService aService, 
//			AnnotationLayer aLayer,
//			AnnotationPreference aPreferences, 
//			Map<String[], Queue<String>> aColorQueues)
...
//	}
	...
	private static String nextPaletteEntry(
			String[] aPalette,
			Map<String[], Queue<String>> aPaletteCursors, 
			int aThreshold)
	{
	...
	public final static String[] PALETTE_NORMAL_FILTERED = filterLightColors(PALETTE_NORMAL, LIGHTNESS_FILTER_THRESHOLD);
	
	public final static String[] PALETTE_PASTEL_FILTERED = filterLightColors(PALETTE_PASTEL, LIGHTNESS_FILTER_THRESHOLD);
