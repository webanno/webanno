 ...
 */
package de.tudarmstadt.ukp.clarin.webanno.ui.monitoring.page.codebook;
...
import de.tudarmstadt.ukp.clarin.webanno.ui.monitoring.page.codebook.CodebookAgreementPage.CodebookAgreementFormModel;

public class CodebookAgreementTable
    extends Panel
{
    ...
    public CodebookAgreementTable(String aId, IModel<CodebookAgreementFormModel> iModel,
                ...
                AJAXDownload download = new AJAXDownload() {
                    ...
                    protected IResourceStream getResourceStream()
                    {
                        return new AbstractResourceStream() {
                            ...
                            {
                                try {
                                    AgreementResult result = CodebookAgreementTable.this
