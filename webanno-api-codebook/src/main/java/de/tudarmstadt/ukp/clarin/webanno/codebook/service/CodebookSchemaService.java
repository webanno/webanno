...
/**
 * This interface contains methods which are related to CodebookCategory, CodebookTag and Type for the annotation
 * project.
 */
public interface CodebookSchemaService
{
    ...
    /**
     * creates a {@link CodebookTag} for a given {@link CodebookCategory}. Combination of {@code tag name} and
     * {@code category name} should be unique
     *
     * @param aTag
     *            the tag.
     */
