				...
				protected void populateItem(ListItem<AnnotationLayer> item) {
					...
					layer_cb.add(new AjaxEventBehavior("change") {
						...
						protected void onEvent(AjaxRequestTarget target) {
							...
							target.appendJavaScript(String.format("alert('%s -> %s')", item.getModelObject().getName(), item.getModelObject().isEnabled()));
						}
					});
					item.add(layer_cb);
					...
					Model<ColoringStrategyType> initialSelected = Model.of(AnnotationLayerDetailForm.this.getModelObject().colorPerLayer.get(item.getModelObject().getId()));
					...
					layer_color.add(new AjaxFormComponentUpdatingBehavior("change") {
						...
						protected void onUpdate(AjaxRequestTarget target) {
							...
							AnnotationLayerDetailForm.this.getModelObject().colorPerLayer.put(current_layer.getId(), selectedColor);
						}
					});
