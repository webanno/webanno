    ...
    extends AnnotationPageBase
{
    ...
    private void handleParameters(StringValue aProjectParameter, StringValue aDocumentParameter,
            StringValue aNameParameter, StringValue aFocusParameter, boolean aLockIfPreset)
    {
